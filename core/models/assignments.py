...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        assignment = Assignment.get_by_id(_id)
        assert grade in GradeEnum.__members__.values()
        assertions.assert_found(assignment, "No assignment with this id was found")
        assertions.assert_valid(
    ...
    def mark_principal(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(
            assignment.state != AssignmentStateEnum.DRAFT,
            "no drafted submissions allowed",
        )
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        assertions.assert_found(
            Teacher.get_by_id(teacher_id), "No teacher with this id was found"
        )
        teachers_assignments = cls.filter(cls.teacher_id == teacher_id).all()
